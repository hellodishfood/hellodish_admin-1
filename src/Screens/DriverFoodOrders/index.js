...
function DriverFoodOrders() {
  ...
  const GetOrders = () => {
    ...
    fetch(
      `${baseurl}admin/api/getAllOrder/${data?.driver._id}/1`,
      requestOptions
    )
              ...
              <div className="collapse navbar-collapse justify-content-between">
                <div className="header-left">
                  <div className="nav-item">
                    <h2 className="my-2 me-auto">Driver Orders List</h2>
                ...
                <div className="card pending">
                  <div className="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div className="menu">
                      ...
                      <h4>{data?.orders?.countPendingOrder}</h4>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card completed">
                  <div className="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div className="menu">
                      ...
                      <h4>{data?.orders?.countCompleteOrder}</h4>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card cancelled">
                  <div className="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div className="menu">
                      ...
                      <h4>{data?.orders?.countCancelOrder}</h4>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="card active-orders">
                  <div className="card-body d-flex align-items-center justify-content-between">
                    ...
                    <div className="menu">
                      ...
                      <h4>{data?.orders?.countActiveOrder}</h4>
                    </div>
                  </div>
                </div>
              </div>
...
export default DriverFoodOrders;
