                          ...
                          <div className="avatar-preview">
                            <div
                              ...
                              style={{
                                ...
                                // backgroundImage: imageUploadFile?.pandCard
                                //   ? `url(${URL.createObjectURL(
                                //       imageUploadFile?.pandCard
                                //     )})`
                                //   : // : 'url("images/avatar/aad-f.svg")'
                                //     `url("${image?.pandCard}")`,
                              }}
                          ...
                          <div className="avatar-preview">
                            <div
                              ...
                              style={{
                                ...
                                // imageUploadFile?.drivingLicenseFront
                                //   ? `url(${URL.createObjectURL(
                                //       imageUploadFile?.drivingLicenseFront
                                //     )})`
                                //   : // : 'url("images/avatar/aad-f.svg")'
                                //     `url("${image?.drivingLicenseFront}")`,
                              }}
                            ></div>
                          </div>
                        </div>
                          ...
                          <div className="avatar-preview">
                            <div
                              ...
                              style={{
                                ...
                                // imageUploadFile?.drivingLicenseBack
                                //   ? `url(${URL.createObjectURL(
                                //       imageUploadFile?.drivingLicenseBack
                                //     )})`
                                //   : // : 'url("images/avatar/aad-f.svg")'
                                //     `url("${image?.drivingLicenseBack}")`,
                              }}
                            ></div>
                          </div>
                        </div>
