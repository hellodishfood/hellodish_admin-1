                  ...
                  <div class="nav-item">
                    <div class="d-flex align-items-center gap-3">
                      ...
                      <h2 class="mb-0 me-auto">
                        {data?.order?.restaurantId?.restaurantName}
                      </h2>
                    </div>
                  </div>
                </div>
        ...
        <div class="content-body">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-4">
                <div class="">
                  <h4 class="mb-3 me-auto">Order ID #{data?.order?._id}</h4>
                </div>
                <div class="d-flex align-items-center justify-content-between">
                  <div class="card-right1-details">
                    {data?.order?.status === 1 ? (
                      <h3>Order Pending</h3>
                    ) : data?.order.status === 2 ? (
                    ...
                    {data?.order?.orderItems.map((item) => (
                      <span>
                        <p class="mb-0">
                          {item.quantity} x <strong>{item.item}</strong>
                        </p>
                    ...
                    <p>
                      <strong>{data?.order?.totalCost?.toFixed(2)} /-</strong>
                      <span class="text-muted">Paid</span>
                    </p>
                  </div>
                  <div class="card-right2-details">
                    <img src="images/avatar/order-img.svg" class="" />
                    <p>{data?.datetime}</p>
                  </div>
                </div>
                <div class="card card-right-details">
                  <div class="d-flex align-items-center justify-content-between order-price-summery">
                    <span class="text-muted">Item Total</span>
                    <strong class="text-black">
                      {data?.order?.orderPrice?.toFixed(2)}
                    </strong>
                  </div>
                  <div class="d-flex align-items-center justify-content-between ">
                    <span class="text-muted">Delivery Charge</span>
                    <strong class="text-black">
                      {data?.order?.deliveryCharge.toFixed(2)}
                      {/* <span class="text-success text-bold">Free</span> */}
                    </strong>
                  </div>
                  <div class="d-flex align-items-center justify-content-between ">
                    <span class="text-muted">Restaurant GST</span>
                    <strong class="text-black">{data?.order?.gstCharge?.toFixed(2)}</strong>
                  </div>
                  <div class="d-flex align-items-center justify-content-between order-price-summery">
                    <span class="text-muted">Restaurant Packing</span>
                    <strong class="text-black">
                      {data?.order?.packingCharge}
                    </strong>
                  </div>
                  <div class="d-flex align-items-center justify-content-between ">
                    <strong class="text-black">PAID</strong>
                    <strong class="text-black">
                      {data?.order?.totalCost.toFixed(2)}
                    </strong>
                  </div>
                </div>
                <div class="d-flex align-items-center justify-content-between order-price-summery">
                  <h4 class="text-muted">Admin paid to Restaurant</h4>
                  {data?.order?.adminPaidToRestaurant === 0 ? (
                    <button class="btn btn-danger">Pending</button>
                  ) : (
                    <button class="btn btn-success1">Done</button>
                  )}
                </div>
                <div class="d-flex align-items-center justify-content-between order-price-summery">
                  <h4 class="text-muted">Admin paid to Driver</h4>
                  {data?.order?.adminPaidToDriver === 0 ? (
                    <button class="btn btn-danger">Pending</button>
                  ) : (
                    <button class="btn btn-success1">Done</button>
                  )}
                ...
                <div class="wrapper my-4">
                  <ul class="StepProgress">
                    <li class="StepProgress-item is-done">
                      <div class="d-flex align-items-center gap-3">
                        {" "}
                        <strong>Outlett</strong>
                        <span>
                          {data?.order?.restaurantId?.restaurantAddress}
                        </span>
                      </div>
                    </li>
                    <li class="StepProgress-item is-done">
                      <div class="d-flex align-items-center gap-3">
                        ...
                        <strong>
                          <Time
                            lat1={data?.order?.restaurantId?.restaurantLat}
                            lng1={data?.order?.restaurantId?.restaurantLong}
                            lat2={data?.order?.lat}
                            lng2={data?.order?.long}
                          />
                        </strong>
                        <span>
                          {" "}
                          Delivery to
                          {data?.order?.customerLocationId?.address}
                        </span>
                      </div>
                    </li>
                  </ul>
                </div>
                <div class="map-on-details">
                  <div
                    className="map-on-details-inner"
                    style={{
                      border: "0",
                      borderRadius: "50px",
                      width: 600,
                  ...
                  >
                    <MapComponent
                      lat={data?.order?.restaurantId?.restaurantLat}
                      long={data?.order?.restaurantId?.restaurantLong}
                      lat2={data?.order?.lat}
                      long2={data?.order?.long}
                    />
                  </div>
                </div>
              </div>
            ...
            <div class="row mt-4">
              <div class="col-lg-4">
                {Object.keys(data?.restaurantRating).length !== 0 && (
                  <div class="card card-right-details">
                    <div class="d-flex align-items-center justify-content-between ">
                      <div>
                        ...
                        <ul class="d-flex align-items-center gap-2">
                          <li>
                            ...
                            >
                              <path
                                d="M6.08105 1.1413C6.42759 0.333799 7.57241 0.333797 7.91895 1.1413L8.9235 3.48207C9.06821 3.81925 9.38596 4.05011 9.75136 4.08354L12.288 4.31559C13.1631 4.39564 13.5168 5.48442 12.8559 6.06354L10.9401 7.74226C10.6642 7.98408 10.5428 8.35761 10.6239 8.71546L11.1871 11.1996C11.3814 12.0566 10.4552 12.7295 9.70021 12.2799L7.51164 10.9767C7.19638 10.7889 6.80362 10.7889 6.48836 10.9767L4.29979 12.2799C3.54479 12.7295 2.61862 12.0566 2.8129 11.1996L3.37606 8.71546C3.45719 8.35761 3.33582 7.98408 3.05985 7.74226L1.14407 6.06354C0.483182 5.48442 0.836947 4.39564 1.71202 4.31559L4.24865 4.08354C4.61404 4.05011 4.93179 3.81925 5.0765 3.48207L6.08105 1.1413Z"
                                fill={
                                  data?.restaurantRating?.rating >= 1
                                    ? "#F7C604"
                                    : "#B9BBBD"
                                }
                              />
                          ...
                          <li>
                            ...
                            >
                              <path
                                d="M6.08105 1.1413C6.42759 0.333799 7.57241 0.333797 7.91895 1.1413L8.9235 3.48207C9.06821 3.81925 9.38596 4.05011 9.75136 4.08354L12.288 4.31559C13.1631 4.39564 13.5168 5.48442 12.8559 6.06354L10.9401 7.74226C10.6642 7.98408 10.5428 8.35761 10.6239 8.71546L11.1871 11.1996C11.3814 12.0566 10.4552 12.7295 9.70021 12.2799L7.51164 10.9767C7.19638 10.7889 6.80362 10.7889 6.48836 10.9767L4.29979 12.2799C3.54479 12.7295 2.61862 12.0566 2.8129 11.1996L3.37606 8.71546C3.45719 8.35761 3.33582 7.98408 3.05985 7.74226L1.14407 6.06354C0.483182 5.48442 0.836947 4.39564 1.71202 4.31559L4.24865 4.08354C4.61404 4.05011 4.93179 3.81925 5.0765 3.48207L6.08105 1.1413Z"
                                fill={
                                  data?.restaurantRating?.rating >= 2
                                    ? "#F7C604"
                                    : "#B9BBBD"
                                }
                              />
                          ...
                          <li>
                            ...
                            >
                              <path
                                d="M6.08105 1.1413C6.42759 0.333799 7.57241 0.333797 7.91895 1.1413L8.9235 3.48207C9.06821 3.81925 9.38596 4.05011 9.75136 4.08354L12.288 4.31559C13.1631 4.39564 13.5168 5.48442 12.8559 6.06354L10.9401 7.74226C10.6642 7.98408 10.5428 8.35761 10.6239 8.71546L11.1871 11.1996C11.3814 12.0566 10.4552 12.7295 9.70021 12.2799L7.51164 10.9767C7.19638 10.7889 6.80362 10.7889 6.48836 10.9767L4.29979 12.2799C3.54479 12.7295 2.61862 12.0566 2.8129 11.1996L3.37606 8.71546C3.45719 8.35761 3.33582 7.98408 3.05985 7.74226L1.14407 6.06354C0.483182 5.48442 0.836947 4.39564 1.71202 4.31559L4.24865 4.08354C4.61404 4.05011 4.93179 3.81925 5.0765 3.48207L6.08105 1.1413Z"
                                fill={
                                  data?.restaurantRating?.rating >= 3
                                    ? "#F7C604"
                                    : "#B9BBBD"
                                }
                              />
                          ...
                          <li>
                            ...
                            >
                              <path
                                d="M6.08105 1.1413C6.42759 0.333799 7.57241 0.333797 7.91895 1.1413L8.9235 3.48207C9.06821 3.81925 9.38596 4.05011 9.75136 4.08354L12.288 4.31559C13.1631 4.39564 13.5168 5.48442 12.8559 6.06354L10.9401 7.74226C10.6642 7.98408 10.5428 8.35761 10.6239 8.71546L11.1871 11.1996C11.3814 12.0566 10.4552 12.7295 9.70021 12.2799L7.51164 10.9767C7.19638 10.7889 6.80362 10.7889 6.48836 10.9767L4.29979 12.2799C3.54479 12.7295 2.61862 12.0566 2.8129 11.1996L3.37606 8.71546C3.45719 8.35761 3.33582 7.98408 3.05985 7.74226L1.14407 6.06354C0.483182 5.48442 0.836947 4.39564 1.71202 4.31559L4.24865 4.08354C4.61404 4.05011 4.93179 3.81925 5.0765 3.48207L6.08105 1.1413Z"
                                fill={
                                  data?.restaurantRating?.rating >= 4
                                    ? "#F7C604"
                                    : "#B9BBBD"
                                }
                              />
                          ...
                          <li>
                            ...
                            >
                              <path
                                d="M6.08105 1.1413C6.42759 0.333799 7.57241 0.333797 7.91895 1.1413L8.9235 3.48207C9.06821 3.81925 9.38596 4.05011 9.75136 4.08354L12.288 4.31559C13.1631 4.39564 13.5168 5.48442 12.8559 6.06354L10.9401 7.74226C10.6642 7.98408 10.5428 8.35761 10.6239 8.71546L11.1871 11.1996C11.3814 12.0566 10.4552 12.7295 9.70021 12.2799L7.51164 10.9767C7.19638 10.7889 6.80362 10.7889 6.48836 10.9767L4.29979 12.2799C3.54479 12.7295 2.61862 12.0566 2.8129 11.1996L3.37606 8.71546C3.45719 8.35761 3.33582 7.98408 3.05985 7.74226L1.14407 6.06354C0.483182 5.48442 0.836947 4.39564 1.71202 4.31559L4.24865 4.08354C4.61404 4.05011 4.93179 3.81925 5.0765 3.48207L6.08105 1.1413Z"
                                fill={
                                  data?.restaurantRating?.rating >= 5
                                    ? "#F7C604"
                                    : "#B9BBBD"
                                }
                              />
                          ...
                          <li>
                            <h5 class="mb-0">
                              {data?.restaurantRating?.rating}.0
                            </h5>
                          </li>
                        </ul>
                      </div>
                      <div>
                        <img src="images/avatar/order-img1.svg" alt="" />
                      </div>
                    </div>
                  </div>
                )}
                {Object.keys(data?.driverRating).length !== 0 && (
                  <div class="card card-right-details">
                    <div class="d-flex align-items-center justify-content-between ">
                      <div>
                        <h3>Driver Rating</h3>
                        <ul class="d-flex align-items-center gap-2">
                          ...
                          <li>
                            <h5 class="mb-0">{data?.driverRating?.rating}.0</h5>
                          </li>
                        </ul>
                      </div>
                      <div>
              ...
              <div class="col-lg-4">
                <div class="card card-right-details">
                  ...
                  <div class="d-flex align-items-center justify-content-between mb-3">
                    <div class="d-flex align-items-center gap-2">
                      <img src="images/avatar/mini-order.svg" />
                      <div>
                        <p class="mb-0">
                          {data?.order?.restaurantId?.restaurantName}
                        </p>
                ...
                {data?.order?.driverAcceptStatus !== 0 && (
                  <div class="card card-right-details">
                    ...
                    <div class="d-flex align-items-center justify-content-between mb-3">
                      <div class="d-flex align-items-center gap-2">
                        <img src="images/avatar/mini-order.svg" />
                        <div>
                          <p class="mb-0">{data?.order?.driverId?.name}</p>
                          <small>{data?.order?.driverId?.phone}</small>
                        </div>
                      </div>
                      <div>
                        <a href="#">
              ...
              <div class="col-lg-4">
                <div class="card card-right-details">
                  ...
                  <div class="d-flex align-items-center justify-content-between ">
                    <div class="d-flex align-items-center gap-2">
                      <div>
                        <p class="mb-0">Delivery at </p>
                        <span>{data?.order?.customerLocationId?.address}</span>
                      </div>
                    </div>
                    {data?.order?.status === 1 ? (
                      <button type="button" class="main_btn main_btn-border">
                        Order Pending
                      </button>
                    ) : data?.order.status === 2 ? (
                      <button type="button" class="main_btn main_btn-border">
          ...
          {data?.order?.cancelStatus !== 0 ? (
            <div className="loadercontainer">
              {data?.order?.rejectByRestaurant === 1 ? (
                <h2 style={{ color: "red" }}>Order Rejected by Restaurant</h2>
              ) : (
                <h2 style={{ color: "red" }}>
                  Order Cancelled by{" "}
                  {data?.order?.cancelStatus === 1 ? "Restaurant" : "Customer"}
                </h2>
              )}
            </div>
          ) : null}
