...
`;
  function GetData() {
    ...
    fetch(
      `${baseurl}admin/api/getReports/0/${data?.restaurant?._id}`,
      requestOptions
    )
              ...
              <div className="collapse navbar-collapse justify-content-between">
                <div className="header-left">
                  <div className="nav-item">
                    <div className="annalytict-top">
                      {data?.restaurant?.profileImage !== "" ? (
                        <img
                          src={`${baseurl}${data?.restaurant?.profileImage}`}
                          alt=""
                      ...
                      <div>
                        <h4>
                          <b>{data?.restaurant?.restaurantName}</b>
                        </h4>
                        <p className="mb-0">
